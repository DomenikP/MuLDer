...
<model ref="r:06d8850f-0312-4c60-bb17-8304a635a8f7(testcode.mbeddr.debugger.testingDefault.testingDefault)">
  ...
  <node concept="2v9HqL" id="7Y7QNUtTGSp">
    <node concept="2eOfOl" id="7Y7QNUtTIfB" role="2ePNbc">
      ...
      <node concept="2v9HqM" id="2M$$wSPtHMv" role="2eOfOg">
        <ref role="2v9HqP" node="2M$$wSPtHK4" resolve="TestingDefault" />
      </node>
    </node>
  ...
  <node concept="N3F5e" id="2M$$wSPtHK4">
    ...
    <node concept="5PU9M" id="2M$$wSPtHKi" role="N3F5h">
      ...
      <node concept="3cQ7KT" id="1kvAObQzsGd" role="lGtFl">
        <property role="TrG5h" value="onEmptyTC" />
      </node>
    </node>
