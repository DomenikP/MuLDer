...
<model ref="r:47842889-17dd-473e-8cc2-d9e1dc8e9eab(tests.__spreferences.PlatformTemplates)">
  ...
  <node concept="2xbcct" id="3OD9RudqxgA">
    <node concept="2xbbuh" id="3OD9RudqxgC" role="2xbcco">
      <property role="TrG5h" value="Desktop Platform" />
      <node concept="2AWWZL" id="3OD9RudqxgB" role="2xbbhh">
