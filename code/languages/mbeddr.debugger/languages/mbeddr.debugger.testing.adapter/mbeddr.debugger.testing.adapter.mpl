...
<language namespace="mbeddr.debugger.testing.adapter" uuid="f9c49961-72fd-4908-826c-b9e67ef3b152" version="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator generatorUID="mbeddr.debugger.testing.adapter#1544753198470029199" uuid="179a7108-bdf6-422b-9806-99ec0a6cf2d0">
      <models>
        <modelRoot contentPath="${module}" type="default">
