...
<model ref="r:c0435792-d5c7-4bfd-97f5-b33191fc771d(test.mbeddr.debugger.components)">
  ...
  <node concept="309jyn" id="7Y7QNUtTPIR">
        ...
        <node concept="2cbQls" id="7HBsxOmZPHB" role="2f_Tkj">
          ...
          <node concept="1jQ9m8" id="7HBsxOmZPI1" role="2cbQmx">
            <node concept="vbKqm" id="7HBsxOmZPIc" role="vaTOg">
              <ref role="vbKqn" to="kucp:hDlKChUcuw" resolve="log" />
            </node>
    ...
    <node concept="U_CzD" id="2WFYmvbZoI9" role="UwsDd">
      <node concept="U_Css" id="2WFYmvbZoIe" role="U_Czc" />
      <node concept="U_CsH" id="2WFYmvbZoIs" role="U_Czc" />
      <node concept="U_Csd" id="2WFYmvbZoIn" role="U_Czc" />
      <node concept="29bEnc" id="2WFYmvbZoIc" role="U_Czs" />
    </node>
  </node>
</model>
