...
<language namespace="mulder.modelgen" uuid="77535ba7-24b5-4667-bf00-2e9c9074a90d" version="0">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator name="" generatorUID="mulder.modelgen#9169053642118083764" uuid="68c0aa7a-6889-4786-88bd-686b1c7ea1d5">
      <models>
        <modelRoot contentPath="${module}" type="default">
      ...
      <dependencies>
        ...
        <dependency reexport="false">1b4696c4-7581-4b83-b80e-990bd5d0c762(mulder.generator.runtime)</dependency>
        <dependency reexport="false">ec2a91d9-299c-4a21-ab13-4e7e4f6f44d9(mulder.base#1229019237294225049)</dependency>
      ...
      <languageVersions>
        ...
        <language id="77535ba7-24b5-4667-bf00-2e9c9074a90d" fqName="mulder.modelgen" version="-1" />
        <language id="59a09bf6-2b13-49ef-80d1-741985a7f0ed" fqName="mulder.tracing" version="0" />
      </languageVersions>
      <mapping-priorities>
        <mapping-priority-rule kind="strictly_before">
          <greater-priority-mapping>
            <generator generatorUID="68c0aa7a-6889-4786-88bd-686b1c7ea1d5(mulder.modelgen#9169053642118083764)" />
            <external-mapping>
              <mapping-set>
                <mapping-set-element>
                  <mapping-node modelUID="r:9ed22999-f1e2-4e78-a248-5131227bf2a3(mulder.modelgen.generator.template.main@generator)" nodeID="3304628194967698026" />
                </mapping-set-element>
                <mapping-set-element>
                  <mapping-node modelUID="r:9ed22999-f1e2-4e78-a248-5131227bf2a3(mulder.modelgen.generator.template.main@generator)" nodeID="7872820068848431578" />
                </mapping-set-element>
              </mapping-set>
            </external-mapping>
          </greater-priority-mapping>
          <lesser-priority-mapping>
            <generator generatorUID="ec2a91d9-299c-4a21-ab13-4e7e4f6f44d9(mulder.base#1229019237294225049)" />
            <external-mapping>
              <mapping-set>
                <mapping-set-element>
                  <mapping-node modelUID="r:964ecf98-202b-480b-b409-e0cd58844391(mulder.base.generator.template.main@generator)" nodeID="2933779798699395714" />
                </mapping-set-element>
                <mapping-set-element>
  ...
  <dependencies>
    ...
    <dependency reexport="true">1b4696c4-7581-4b83-b80e-990bd5d0c762(mulder.generator.runtime)</dependency>
    ...
    <dependency reexport="false" scope="generate-into">59a09bf6-2b13-49ef-80d1-741985a7f0ed(mulder.tracing)</dependency>
  </dependencies>
  <usedLanguages>
  ...
  <extendedLanguages>
    ...
    <extendedLanguage>f2600f3d-2083-4803-a693-cff3268f4af9(mulder.model)</extendedLanguage>
  </extendedLanguages>
</language>
